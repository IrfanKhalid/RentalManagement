...
import {ResponseMessageComponent} from './Shared/response.message.component';
...
import {MemberPlotListComponent} from './MemberRegistration/app.MemberPlotListComponent';
...
import { AttachOnePlotComponent } from './MemberRegistration/attach-one-plot/attach-one-plot.component';
import {AllMemberRegistration } from './MemberRegistration/app.AllMemberRegistration.component';
import {ViewMemberRegistrationComponent} from './MemberRegistration/app.ViewMemberRegistration.component';
@NgModule({
  declarations: [
    AppComponent,
    ...
    MemberListComponent,
    MemberPlotListComponent,
    MemberViewComponent,
    EditMemberRegistrationComponent,
    ViewMemberRegistrationComponent,
    ...
    RouterModule.forRoot([
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'View/:MemberId', component: ViewMemberRegistrationComponent ,canActivate: [UserAuthGuardService]},          
          { path: 'All', component: MemberViewComponent ,canActivate: [UserAuthGuardService]},
          {path:'AttachPlot/:MemberId',component:AttachOnePlotComponent,canActivate:[UserAuthGuardService]}
        ]
      },
      {
        path: 'User',
