...
@Component({
    selector: 'plot-overview',
    templateUrl: 'MemberPlotlist.component.html',   
...
export class MemberPlotListComponent {

    dataSource = new MatTableDataSource<PlotGridModel>();
    displayedColumns: string[] = ['PlotNo', 'PlotArea', 'RateperMerla' ,'PriceToBeDecided', 'Total','BookingDate','AddPayment'];
  
    _Route: any;

    @Input('dataSource')
    set dataSourceForTable(value: PlotGridModel[]) 
    {
        this.dataSource = new MatTableDataSource<PlotGridModel>(value);
    }
